...
OPTION(thinstore_enable, OPT_BOOL)
OPTION(sd_q_policy, OPT_INT)
OPTION(messenger_null_test, OPT_BOOL)
OPTION(front_ack_backend_do_nothing, OPT_BOOL)
OPTION(front_ack_backend_do_flush, OPT_BOOL)
OPTION(osd_level_batch_flush, OPT_BOOL)
OPTION(sd_use_original_backend, OPT_BOOL)
OPTION(issue_io_first_async_io, OPT_BOOL)
OPTION(issue_io_first_async_io_batch, OPT_BOOL)
OPTION(issue_io_first_null_test, OPT_BOOL)
OPTION(issue_io_first_direct_io, OPT_BOOL)
OPTION(osd0_path, OPT_STR)
OPTION(osd1_path, OPT_STR)
OPTION(osd2_path, OPT_STR)
