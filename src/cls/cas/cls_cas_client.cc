...
void cls_chunk_refcount_set(librados::ObjectWriteOperation& op, vector<hobject_t>& refs)
{
  bufferlist in;
...
int cls_chunk_refcount_read(librados::IoCtx& io_ctx, string& oid, vector<hobject_t> *refs)
{
  bufferlist in, out;
