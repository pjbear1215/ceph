...
public:
  ...
  virtual OrderLockerRef get_order_locker(PGRef &pg, OSD *osd) = 0;
...
public:
  ...
  OrderLockerRef get_order_locker(PGRef &pg, OSD *osd) {
    assert(qitem);
    return qitem->get_order_locker(pg, osd);
  }
