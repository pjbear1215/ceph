...
public:
  ...
  public:
    ...
    void finish(int r) {
      //if (!comp_item) assert(0);
      //assert(rep_gather);
      //comp_item->comp_lock.Lock();
      assert(comp_item);
      comp_item->lock();
      c->complete(r);
      comp_item->unlock();
  ...
  void log_operation(
    ...
    append_log(logv, trim_to, trim_rollback_to, t, transaction_applied, NULL);
  }
  ...
  void log_operation(
    ...
    append_log(logv, trim_to, trim_rollback_to, t, transaction_applied, comp_item);
  }
...
public:
  ...
  bool do_lazy_completion(bool need_lock);
  void boost_lazy_completion(OpContext *ctx);
